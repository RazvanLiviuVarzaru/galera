...
#
STRING(REGEX MATCH "EPOCH=([0-9a-zA-Z]*)" _ ${ver})
SET(GALERA_EPOCH ${CMAKE_MATCH_1})
#
set(GALERA_VERSION
...
CONFIGURE_FILE(${PROJECT_SOURCE_DIR}/debian/changelog.in ${PROJECT_SOURCE_DIR}/debian/changelog @ONLY)
